...
img_advisory = Image.open(r_dir / "real_advisory_meeting.jpg").convert("RGB")
...
for frame_idx in range(total_frames):
    ...
    # 6. Beat 6 [15.00s - 21.00s]: SPLIT_50_50 (Real Advisory Floorplan Blueprint + Official Logo)
    elif t < 21.00:
        p = (t - 15.00) / 6.00
        scale = 1.02 + 0.06 * p
        pan = -0.15 + 0.3 * p
    ...
    # 7. Beat 7 [21.00s - 28.50s]: FULL_EXPLAINER (Real DLF Cyber City Gurgaon & Expressway)
    elif t < 28.50:
        p = (t - 21.00) / 7.50
        scale = 1.02 + 0.07 * p
        canvas = fit_cover(img_cybercity, 1080, 1920, scale_boost=scale, pan_y=p * 0.12).convert("RGBA")
...
audit_vid.release()
print("FINAL REAL MASTER RENDER COMPLETED SUCCESSFULLY!")
