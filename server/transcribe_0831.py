...
vid_path = r"D:\Downloads\0831.mp4"
work_dir = Path(r"c:\websites\ai video production tool\storage\deliverables\voxpipe_0831")
...
print("Hindi Full Text:")
print(result_hi.get("text", ""))
print("\nEnglish Translation Full Text:")
print(result_en.get("text", ""))
